...
function classifyCategory(text) {
  ...
  const map = [
    ...
    ['джем[- ]сесси', 'Джем-сессия'],
    ['пикник|барбек|мангал', 'Пикник / Барбекю'],
    ['настольн|настолк', 'Настольные игры'],
    ['квест|пазлрум|escape', 'Квест'],
    ['кинопоказ|киноноч|сеанс|фильм|кино|кинематограф', 'Кино'],
    ['лекци|дискусси|обсуждени|дебат|панель|форум', 'Лекция / Дискуссия'],
    ['выставк|экспозиц|галере', 'Выставка'],
    ['театр|спектакл|постановк|премьер', 'Театр'],
    ['экскурс|гид|прогулк|пешеходн|обзорн', 'Экскурсия'],
    ['мастер[- ]класс|воркшоп|семинар|заняти|урок|обучени', 'Мастер-класс / Воркшоп'],
    ['фестиваль|фест', 'Фестиваль'],
    ['концерт|джаз|рок|жив(ая|ой) музыка|сет|лайв|выступлени', 'Концерт'],
    ['танцевальн|танц[еы]|рейв|дискотек|party|вечеринк', 'Танцевальная вечеринка'],
    ['вечеринк|party', 'Вечеринка'],
    ['забег|марафон|йога|турнир|матч|спортив|фитнес|бег|тренировк|пробег', 'Забег / Спортивное событие'],
    ['путешеств|поход|хайк|трип|треккинг|экспедиц', 'Путешествие'],
